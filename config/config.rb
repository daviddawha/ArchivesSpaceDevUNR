...
AppConfig[:db_url] = "jdbc:mysql://localhost:3306/archivesspace?user=aspace&password=planets-3PAw2M@P&useUnicode=true&characterEncoding=UTF-8"
##
...
AppConfig[:solr_backup_schedule] = "* 3 * * *"
#AppConfig[:solr_backup_number_to_keep] = 1
AppConfig[:solr_backup_number_to_keep] = 2
#AppConfig[:solr_backup_directory] = proc { File.join(AppConfig[:data_directory], "solr_backups") }
AppConfig[:solr_backup_directory] = "/media/cifs/backup/solar" 
...
AppConfig[:plugins] = ['local', 'lcnaf', 'aspace-search-identifier', 'orphan_finder_job']
#
...
AppConfig[:frontend_proxy_url] = "https://archive-dev.library.unr.edu/staff"
#AppConfig[:public_proxy_url] = proc { AppConfig[:public_url] }
AppConfig[:public_proxy_url] = "https://archive-dev.library.unr.edu/public"
#
...
AppConfig[:authentication_sources] = [{
	:model => 'LDAPAuth',
	:hostname => 'rodc.unr.edu',
	:port => 636,
	:base_dn => 'dc=unr,dc=edu',
	:username_attribute => 'sAMAccountName',
	:attribute_map => {:cn => :name},
	:bind_dn => 'CN=Dig Archivebinder,OU=Service Accounts,OU=Users,OU=Domain Admin,DC=unr,DC=edu',
	:bind_password => 'foiling-TGc8RJ!AGyeA',
...
#AppConfig[:feedback_url] = "https://nevada.formstack.com/forms/archivespacefeedback"
AppConfig[:feedback_url] = "https://library.unr.edu/specoll/archival-guides-help"
#
